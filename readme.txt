...
With this plugin you can create forms with multiple input fields and have your users pay before submission.

= Forms with recurring payments =

To create a form so your users can make quick and easy payments for a standard fee.
