                                ...
                                <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="column_cell font_default" align="center" valign="top"
                                            ...
                                            <p style="font-family:Helvetica,Arial,sans-serif;font-size:28px;line-height:23px;margin-top:16px;margin-bottom:24px">
                                    ...
                                    <tr>
                                        <td class="column_cell font_default" align="center" valign="top"
                                            ...
                                            <p style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:23px;margin-top:16px;margin-bottom:24px">
                                                You're getting this email because <br/>you tried making a payment
                                                ...
                                                <tr>
                                                    <p style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:23px;margin-top:16px;margin-bottom:24px">
                                                        <small class="text-muted"
                                                            ...
                                                            this link below to try again, if you encountered <br/>any
                                                            issue while trying to make the payment.</small><br>
                                                    </p>
...
function spg_wp_siliconpay_send_receipt($id, $currency, $amount, $name, $email, $code, $metadata)
{
    ...
    <head>
        ...
        <style type="text/css">body {
            ...
            .pricing_box h1, .pricing_box h2, .primary_pricing_box h1, .primary_pricing_box h2 {
                line-height: 20px;
                Margin-top: 16px;
                Margin-bottom: 0
            }
            ...
            .email_container, .header_cell, .jumbotron_cell, .content_cell, .footer_cell, .image_responsive {
                font-size: 0 !important;
                text-align: center
            }

            .header_cell, .footer_cell {
                padding-bottom: 16px
            }

            .header_cell .column_cell, .footer_cell .col-13 .column_cell, .footer_cell .col-1 .column_cell {
                text-align: left;
                padding-top: 16px
            }
            ...
            body, .email_body, .header_cell, .content_cell, .footer_cell {
                background-color: #fff
            }

            .secondary_btn td, .icon_primary .icon_cell, .primary_pricing_box {
                background-color: #2f68b4
            }

            .jumbotron_cell, .pricing_box {
            ...
            .primary_btn a, .primary_btn span, .secondary_btn a, .secondary_btn span, .label .font_default, .primary_pricing_box, .primary_pricing_box h1, .primary_pricing_box small {
                color: #fff
            }
            ...
            .header_cell .column_cell, .header_cell a, .header_cell a span, h1, h3, a, a span, .text-secondary, .column_cell .text-secondary, .content_cell h2 .text-secondary {
                color: #2f68b4
            }

            .footer_cell a, .footer_cell a span {
                color: #7a7a7a
            }

            .text-muted, .footer_cell .column_cell, .content h4 span, .content h3 span {
                color: #b3b3b5
            }
            ...
            .header_cell, .footer_cell, .jumbotron_cell, .content_cell {
                border-left: 4px solid;
                border-right: 4px solid
            }

            .footer_cell, .product_row, .order_total {
                border-top: 1px solid
            }

            .header_cell, .footer_cell, .jumbotron_cell, .content_cell, .product_row, .order_total, .icon_secondary .icon_cell, .footer_cell, .content .product_row, .content .order_total, .pricing_box, .text_quote .column_cell {
                border-color: #d8dde4
            }
                                ...
                                <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="column_cell font_default" align="center" valign="top"
                                            ...
                                            <p align="left"
                                               style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:23px;margin-top:16px;margin-bottom:24px"><?php echo $sitemessage; ?></p>
                                            <p style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:23px;margin-top:16px;margin-bottom:24px">
                                                &nbsp; </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="column_cell font_default" align="center" valign="top"
                                            ...
                                            <small style="font-size:86%;font-weight:normal"><strong>Notice</strong><br>
                                                You're getting this email because you've made a payment
                                ...
                                <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="column_cell font_default" align="center" valign="top"
                                            style="padding:16px 16px 0;font-family:Helvetica,Arial,sans-serif;font-size:15px;text-align:center;vertical-align:top;color:#888">
                                            <small style="font-size:86%;font-weight:normal"><strong>Notice</strong><br>
                                                You're getting this email because someone made a payment
                                                of <?php $currency . ' ' . number_format($amount); ?> to <a
                                                        href="<?php echo get_bloginfo('url') ?>"
                                                        style="display:inline-block;text-decoration:none;font-family:Helvetica,Arial,sans-serif;color:#2f68b4"><?php echo get_option('blogname'); ?></a>.</small>
                                        </td>
...
;
    ...
    ;
            ...
            if (trim($_POST['status']) === 'Successful') {
                //=============================================================
        ...
        $message = "Uncaught Error: Payment Verification Failed.";
        $result = "failed";
    }
...
add_action('wp_ajax_spg_wp_siliconpay_retry_action', 'spg_wp_siliconpay_retry_action');
add_action('wp_ajax_nopriv_spg_wp_siliconpay_retry_action', 'spg_wp_siliconpay_retry_action');
function spg_wp_siliconpay_retry_action()
{
    if (trim($_POST['code']) == '') {
        $response['result'] = 'failed';
    ...
    global $wpdb;
    $code = $_POST['code'];
    $newcode = spg_wp_siliconpay_generate_code();
    $newcode = $newcode . '_2';
    $insert = array();
    $table = $wpdb->prefix . SPG_WP_SILICONPAY_TABLE;
    $record = $wpdb->get_results("SELECT * FROM $table WHERE (txn_code = '" . $code . "')");
    if (array_key_exists("0", $record)) {
        ...
        $fixedmetadata = spg_wp_siliconpay_meta_as_custom_fields($dbdata->metadata);
        ...
        foreach ($nmeta as $nkey => $nvalue) {
            ...
            if ($nvalue->variable_name == 'Phone_Number') {
                $phone = $nvalue->value;
            }
        }
    }
...
add_action('wp_ajax_spg_wp_siliconpay_rconfirm_payment', 'spg_wp_siliconpay_rconfirm_payment');
add_action('wp_ajax_nopriv_spg_wp_siliconpay_rconfirm_payment', 'spg_wp_siliconpay_rconfirm_payment');

function spg_wp_siliconpay_rconfirm_payment()
{
    if (trim($_POST['code']) == '') {
        $response['error'] = true;
        $response['error_message'] = "Did you make a payment?";
    ...
    if (array_key_exists("0", $record)) {
        ...
        $siliconpay_url = 'https://silicon-pay.com/verify/' . $code;
        $headers = array(
            'Authorization' => 'Bearer ' . $key
        );
        $args = array(
        ...
        if (!is_wp_error($request) && 200 == wp_remote_retrieve_response_code($request)) {
            $siliconpay_response = json_decode(wp_remote_retrieve_body($request));
            if ('success' == $siliconpay_response->data->status) {
                $amount_paid = $siliconpay_response->data->amount / 100;
                $siliconpay_ref = $siliconpay_response->data->reference;
                if ($recur == 'optional' || $recur == 'plan') {
                    $wpdb->update($table, array('paid' => 1, 'amount' => $amount_paid), array('txn_code_2' => $siliconpay_ref));
                    $thankyou = get_post_meta($payment_array->post_id, '_successmsg', true);
                    $message = $thankyou;
                    $result = "success";
                } else {
                    if ($amount == 0) {
                        $wpdb->update($table, array('paid' => 1, 'amount' => $amount_paid, 'paid_at' => $paid_at), array('txn_code_2' => $siliconpay_ref));
                        $thankyou = get_post_meta($payment_array->post_id, '_successmsg', true);
                        $message = $thankyou;
                        $result = "success";
                        // spg_wp_siliconpay_send_receipt($currency,$amount,$name,$payment_array->email,$code,$metadata)
                        ...
                        if ($amount != $amount_paid) {
                            ...
                            $wpdb->update($table, array('paid' => 1, 'paid_at' => $paid_at), array('txn_code_2' => $siliconpay_ref));
                            $thankyou = get_post_meta($payment_array->post_id, '_successmsg', true);
                            $message = $thankyou;
                            $result = "success";
                        }
    ...
    if ($result == 'success') {
        //Log to amplitude
        $pstk_logger = new siliconpay_plugin_tracker('spg-siliconpay', Spg_WP_SiliconPay_Public::fetchEncryptionKey());
        $pstk_logger->log_transaction_success($code);
        $sendreceipt = get_post_meta($payment_array->post_id, '_sendreceipt', true);
        if ($sendreceipt == 'yes') {
            $decoded = json_decode($payment_array->metadata);
